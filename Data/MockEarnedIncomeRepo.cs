...
namespace ChaosEmeraldsOfIncome.Data
{
    public class MockEarnedIncomeRepo : IEarnedIncomeRepo
    {
        ...
        public IEnumerable<EarnedIncome> GetEarnedIncome()
        {
            ...
            {
                new EarnedIncome{ UserId=823, IncomeTitle="Carpenter", IncomeAmount=2000, Frequency="Annual", IsActive=true},
                new EarnedIncome{ UserId=823, IncomeTitle="Plumber", IncomeAmount=3000, Frequency="Annual", IsActive=true},
                new EarnedIncome{ UserId=823, IncomeTitle="Writer", IncomeAmount=2250, Frequency="Annual", IsActive=true}
            };
